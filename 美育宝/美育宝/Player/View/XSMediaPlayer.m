...
//        self.backgroundColor = [UIColor redColor];
        ...
        //返回按钮点击事件
        [self.maskView.backBtn addTarget:self action:@selector(backBtnClick:) forControlEvents:UIControlEventTouchUpInside];
...
{
    //LYOneViewController *oneCon = [[LYOneViewController alloc]init];
    //LYPlayerViewController *playerCon = [[LYPlayerViewController alloc] init];
