...
//    self.backButton.frame    = CGRectMake(0, -0.5*self.frame.size.height+(1.5*self.frame.size.height-64)*(1-alpha), self.backButton.frame.size.width, self.backButton.frame.size.height);
    ...
    self.backButton.transform  = CGAffineTransformScale(t, imageReduce, imageReduce);
