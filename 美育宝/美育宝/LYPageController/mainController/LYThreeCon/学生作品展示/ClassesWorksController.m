...
@interface ClassesWorksController ()<UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource>
{
...
@implementation ClassesWorksController
...
- (void)getImageDataHttpRequest
{
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        NSString *showPhotoUrl = [NSString stringWithFormat:@"http://192.168.3.254:8082/GetDataToApp.aspx?action=getzplistbyday&pagesize=1000&pageindex=1&xh=&bh=%@&isgood=0",stuBjNum];
//        NSLog(@"%@",showPhotoUrl);
