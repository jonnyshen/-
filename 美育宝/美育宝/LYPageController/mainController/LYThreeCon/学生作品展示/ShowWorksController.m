...
@interface ShowWorksController ()<UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource>
{
...
@implementation ShowWorksController
...
//    [self.collectionView addHeaderWithTarget:self action:@selector(getImageDataHttpRequest)];
...
- (void)getImageDataHttpRequest
{
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
       ...
       AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
        ...
        NSString *showPhotoUrl = [NSString stringWithFormat:@"http://192.168.3.254:8082/GetDataToApp.aspx?action=getzplistbyday&pagesize=1000&pageindex=1&xh=%@&bh=&isgood=0",relationCode];
//        NSLog(@"%@",showPhotoUrl);
