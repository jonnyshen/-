...
@interface TeacherShowWorksController ()
{
...
@implementation TeacherShowWorksController
...
- (void)setUpTabBarController
{
    ...
    titleArray = [[NSArray alloc]initWithObjects:@"班级作品",@"优秀作品",@"", nil];
    self.title = titleArray.firstObject;
    TeachClassController *groupChart = [[TeachClassController alloc] init];
//    groupChart = [[UIStoryboard storyboardWithName:@"Three" bundle:nil] instantiateViewControllerWithIdentifier:@"StuChartController"];
    
    TeachExcelentClassController *classChart = [[TeachExcelentClassController alloc] init];
//    classChart = [[UIStoryboard storyboardWithName:@"Three" bundle:nil] instantiateViewControllerWithIdentifier:@"StuGradeController"];
    //    ChartDetailController *chartDetail = [[ChartDetailController alloc] init];
