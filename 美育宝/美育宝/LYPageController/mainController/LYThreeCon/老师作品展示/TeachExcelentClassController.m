//
//  TeachExcelentClassController.m
//  美育宝
//
...
#import "TeachExcelentClassController.h"
...
@interface TeachExcelentClassController ()<UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource>
{
...
@implementation TeachExcelentClassController
...
//        NSString *urlString = [kWORKSURL stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
//        NSURL *codeUrlStr = [NSURL URLWithString:urlString];
//        NSURLRequest *request = [NSURLRequest requestWithURL:codeUrlStr cachePolicy:NSURLRequestReloadIgnoringLocalCacheData timeoutInterval:10];
//        
//        NSURLResponse *response = nil;
//        NSError *error = nil;
//        
//        NSData *dataBack = [NSURLConnection sendSynchronousRequest:request returningResponse:&response error:&error];
//        NSDictionary *responseObject = [NSJSONSerialization JSONObjectWithData:dataBack options:NSJSONReadingMutableLeaves error:&error];
//       
        
//        NSString *stuBjNum = [tools sendFileString:@"LoginData.plist" andNumber:4];
