...
- (void)viewDidLoad {
    ...
    [self createTextFieldsUI];
}

-(void)createTextFieldsUI
{
    ...
    UIButton *landBtn=[self createButtonFrame:CGRectMake(10, bgView.frame.size.height+bgView.frame.origin.y+30,self.view.frame.size.width-210, 37) backImageName:nil title:@"完成" titleColor:[UIColor whiteColor]  font:[UIFont systemFontOfSize:17] target:self action:@selector(okClick)];
...
//        {
//            [FormValidator showAlertWithStr:@"请输入新密码"];
//            return;
//        }
//        else if (passward.text.length <6)
//        {
//            [FormValidator showAlertWithStr:@"密码必须6-20位字母或数字"];
//            return;
//        }
