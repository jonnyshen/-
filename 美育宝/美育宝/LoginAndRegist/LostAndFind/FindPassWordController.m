...
//    yzButton.font=[UIFont systemFontOfSize:13];
    ...
    UIButton *landBtn=[self createButtonFrame:CGRectMake(10, bgView.frame.size.height+bgView.frame.origin.y+30,self.view.frame.size.width - 210, 37) backImageName:nil title:@"下一步" titleColor:[UIColor whiteColor]  font:[UIFont systemFontOfSize:17] target:self action:@selector(landClick)];
...
//    {
//        [FormValidator showAlertWithStr:@"亲,请输入手机号码"];
//
//        return;
//    }
//    else if (_phone.text.length <11)
//    {
//        [FormValidator showAlertWithStr:@"亲,您输入的手机号码格式不正确"];
//        return;
//    }
...
//        if ([_phone.text isEqualToString:@""])
//        {
//            [FormValidator showAlertWithStr:@"亲,请输入注册手机号码"];
//            
//            return;
//        }
//        else if (_phone.text.length <11)
...
//        {
//            [FormValidator showAlertWithStr:@"亲,请输入密码"];
//            
//            return;
//        }
//    
    NewPassWordController *new=[[NewPassWordController alloc]init];
    //赋值
