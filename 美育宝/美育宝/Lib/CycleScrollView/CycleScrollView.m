...
- (id)initWithFrame:(CGRect)frame animationDuration:(NSTimeInterval)animationDuration Count:(NSInteger)count
{
    ...
    if (animationDuration > 0.0) {
        self.pageCtl = [[UIPageControl alloc]initWithFrame:CGRectMake(ScreenWidth-count*16, self.frame.size.height-20, count*15,20 )];
...
- (void)contentViewTapAction:(UITapGestureRecognizer *)tap
{
    ...
    [self.delegate didSelectImageAtIndex:self.currentPageIndex];
}
