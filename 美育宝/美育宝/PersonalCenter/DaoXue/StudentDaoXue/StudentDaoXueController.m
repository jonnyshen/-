...
@interface StudentDaoXueController ()
{
...
@implementation StudentDaoXueController
...
- (void)setUpTabBar
{
    StuDXListController *list = [[StuDXListController alloc] init];
    StuDXCaculateController *caculate = [[StuDXCaculateController alloc] init];
    self.viewControllers = @[list, caculate];
}
